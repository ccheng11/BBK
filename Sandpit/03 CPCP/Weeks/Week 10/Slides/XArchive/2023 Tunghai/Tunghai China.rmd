...
title: |
  |
  |
  | Using Numbers to Study Mainland China
  |
  |
author: |
  | Chao-Yo Cheng
...
# Introduction: Using numbers to study mainland China
...
\begin{itemize}
  ...
  \vspace{0.6cm}
  \item What you need to work with data
  \vspace{0.6cm}
  \item Examples from past and current research
  \vspace{0.6cm}
  \item Concluding remarks and tips
\end{itemize}

# Why numbers matter: A paradigm shift?

\begin{itemize}
  \item The field of (mainland) China studies has changed significantly in the past decade as a result of \textbf{methodological/technological advances}, (new) \textbf{data availability} and \textbf{geopolitics}
  \vspace{0.5cm}
  \item Quant techniques are essential to \textbf{establish patterns} for theory building and policy impact evaluation
  \vspace{0.5cm}
  \item Using numbers also encourage us to rethink the purpose of mainland China studies -- government and/or governance?
  \vspace{0.5cm}
  \item The use of computational and quantitative data/methods by no means undermine the importance/value of traditional approaches -- \textbf{multi-method/data triangulation} is now the norm
\end{itemize}
...
\begin{itemize}
  \item Surveys (e.g., Chinese General Social Survey)
  \vspace{0.4cm}
  \item Admin data and census (e.g., statistical yearbooks)
  \vspace{0.4cm}
  \item Archives and historical documents, such as
  \vspace{0.1cm}
  \begin{itemize}
    \item Gazetteers
    \item Culture and history materials
  \end{itemize}
  \vspace{0.4cm}
  \item Digital and "big" data (e.g., Weibo and Baidu Index)
\end{itemize}
...
# What you need to work with data

\begin{itemize}
  \item Training in different \textbf{research methods}
  \vspace{1cm}
...
\begin{itemize}
  \item Training of different \textbf{research methods}
  \vspace{0.6cm}
  \item A grasp of potential \textbf{data sources}
  \vspace{0.1cm}
  \begin{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Dual descriptive representation of ethnic cadres
  \end{itemize}
  \vspace{0.3cm}
  \item (Re)mapping the information network of political elites using computational approaches
  \vspace{0.3cm}
