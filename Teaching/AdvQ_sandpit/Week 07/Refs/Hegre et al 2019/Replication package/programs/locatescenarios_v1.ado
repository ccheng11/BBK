capture program drop locatescenarios_v1

program locatescenarios_v1
	version 12
...
/* MUST DEFINE ANOTHER BASELINE SCENARIO FOR WAR/CONFLICT COUTNRIES; MAKE SURE THEY ARE IN WAR */
						...
						if "`scenariostyle'" == "group" {
							...
							*/
							...
							replace scenario = 4 if /// /* Peace in minor conflict countries */
								(sc_cnt == 1 & gwno == 100) | (sc_cnt == 1 & gwno == 432) | (sc_cnt == 1 & gwno == 840) |  ///
							...
							replace scenario = 5 if /// /* Minor conflict in peaceful low-income countries */
								...
								(sc_cnt == 2 & gwno == 731) | (sc_cnt == 2 & gwno == 475)
							...
							replace scenario = 12 if /// /* Major conflict in peaceful low-income countries */
								...
								(sc_cnt == 3 & gwno == 731) | (sc_cnt == 3 & gwno == 475) 
						...
						display "The file Res_`simtype'_1_`i'_`j'_`k'.txt deleted, replaced with 10 scenario-specific files"
				} /* end if _rc==0 */
				else {	
