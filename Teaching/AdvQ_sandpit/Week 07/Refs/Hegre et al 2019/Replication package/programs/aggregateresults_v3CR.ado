...
*						display "dvlb " `dvlb'
					...
					foreach var in sim_0 sim_1 sim_2 sim_3 sim_4 sim_5 phat0 phat1 phat2 phat3 phat4 phat5 `summarize' { /* (removed lgdpcap) Needs generalization */
...
*					forvalues num = 1(1)`yearnos'{
					forvalues num = 2(1)`yearnos'{
						...
						*matrix listcurrentm = currentmeans[1..9,1..9]
						matrix listcurrentm = currentmeans[1..15,1..15]
