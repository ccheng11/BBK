program mergescenarios_v2b
	version 12
    syntax namelist, simsetname(namelist) scenarios(int) depvar(string) depvarvalues(int) simtype(namelist)
...
*/	
	...
	forvalues s = 1(1)`scenarios' { 
		local indata = "Results/" + "`simsetname'" + "/" + "Aggregated_c_`simtype'_1_`s'_x_x.dta"
