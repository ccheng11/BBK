...
*			local parafilename = subinstr("`pfnorig'",".","`mlab'.",1) 
		...
		*schtop
		...
		use "`indata'", clear
		quietly include "Data_manipulation_Temp.do"
		eststo clear
...
*							}
							if `i' > 1 {
								/* NOTE: CURRENTLY WE USE NV NON-LAGGED VERSIONS OF VARIABLES; MAKE SURE THIS MAKES SENSE FOR ALL VARIABLES  */
