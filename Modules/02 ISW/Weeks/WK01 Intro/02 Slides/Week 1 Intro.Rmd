...
\begin{itemize}
  ...
  \vspace{0.1cm}
    ...
    \end{itemize}
  \vspace{0.3cm}
  \item Discussion: What makes "good" social science research?
  \vspace{0.3cm}
...
\begin{itemize}
\small
  \item When: Every Wednesday, 6-9pm
  \item Where: Room 210, Birkbeck Central
  \item Meeting formats
  \begin{itemize}
    \item In-person or recorded lectures
    \item Seminar discussions: In-person; remote participation is possible for students on \textit{online} or \textit{flexible} routes
  \end{itemize}
\end{itemize}
...
\begin{itemize}
\small
  \item \textbf{Weeks 1-5: Varieties of social research} (Dr Chao-Yo Cheng)
  \vspace{0.1cm}
  \begin{itemize}
    \item What makes good social research
  ...
  \end{itemize}
  \vspace{0.3cm}
  \item \textbf{Weeks 6-10: Theorising the social world} (Dr Margarita Aragon)
  \vspace{0.1cm}
  \begin{itemize}
    \item Knowledge production about the social world
    \item Psychosocial framing
    \item Intersectional sensibilities
    \item Situating lived experience
    \item More-than-human worlds
  \end{itemize}
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Due on \textbf{April 2, 2026}
  \end{itemize}
  \vspace{0.7cm}
  \item Analytical essay (60\%)
\end{itemize}
...
\begin{itemize}
  ...
  \vspace{0.1cm}
  \begin{itemize}
    \item Write a 2,500-word essay
    \item More will be discussed in \textbf{Week 6}
    \item Due on \textbf{April 22, 2026}
  \end{itemize}
\end{itemize}
...
# Strategic/deep reading in social sciences

\begin{itemize}
  \item Know why you are reading (see the topic statement of each week)
  \vspace{0.1cm}
  \begin{itemize}
...
\begin{itemize}
  ...
  \vspace{0.5cm}
  \item Debates over epistemological positions: Constructivism versus positivism
  \vspace{0.5cm}
  \item "Methodology:" Qualitative v quantitative? Or even computational?
  \vspace{0.5cm}
  \item Identity and representation: How do you introduce yourself as a social researcher? How does "who you are" matter?
  \vspace{0.5cm}
...
# Concluding remarks (for now): Investigating the social world as a vocation
