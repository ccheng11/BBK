...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \vspace{0.2cm}
    \item Economic modernization: Industrial infrastructure and production (much of this has do with security concerns)
  \end{itemize}
  \vspace{0.3cm}
...
\begin{itemize}
  ...
  \item What else?
  \vspace{0.3cm}
  \item Why it is hard to study the early 20th century China: Taiwan, Hong Kong and Beijing
\end{itemize}
