...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item The \textbf{Xi'an Incident} (西安事变) in 1936 forced him to declare another "CPC-KMT" United Front
...
\small
  ...
  \begin{itemize}
    ...
    \item Much of te long-term impact remains to be explored (e.g., Elizabeth Perry)
