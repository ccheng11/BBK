...
\begincols
  ...
  \hspace{0.3cm}
  \begin{itemize}
    \item Why numbers matter? Why are they useful?
    \vspace{0.5cm}
...
\small
  ...
  \end{itemize}
  \item Changing geopolitical environment also prompts the computational or even quantitative turn in the study of contemporary China
\end{itemize}
